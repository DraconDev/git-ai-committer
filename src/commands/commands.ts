        ...
        try {
          ...
          await vscode.window.withProgress(
            ...
            async (progress) => {
              ...
              } = await import("../features/featureSummaryService.js");
              ...
              const summary = await analyzeCommitsForFeature(commitCount);
              ...
              if (action === "Create Commit") {
                ...
                const success = await createFeatureSummaryCommit(summary);
                ...
                if (success) {
                  ...
                  if (autoVersionBump && summary.versionBump !== "none") {
                    await updateVersion(summary.versionBump);
                    vscode.window.showInformationMessage(
